layui.use(['form', 'laydate', 'table', 'laypage', 'layer', 'element'], function () {
  ...
  function tableRender(data) {
    var arr = [
        { type: "radio" }
        , { field: 'loginNoStr', title: '地市' }
        , { field: 'loginNameStr', title: '业务名称' }
        , { field: 'groupIdStr', title: '证件数量' }
        , { field: 'opTime', title: '协议' }
        , { field: 'validFlag', title: '是否必须读卡' }
        , { field: 'opTime', title: '操作工号' }
        , { field: 'validFlag', title: '	操作时间' }
