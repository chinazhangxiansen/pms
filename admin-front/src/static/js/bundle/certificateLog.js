layui.use(['form', 'laydate', 'table', 'laypage', 'layer', 'element'], function () {
  ...
  function tableRender(data) {
    var arr = [
        // { type: "radio" }
         { field: 'loginNoStr', title: '工单编号' }
        , { field: 'loginNameStr', title: '工号' }
         , { field: 'loginNameStr', title: '工号名称' }
        , { field: 'opTime', title: '操作时间' }
        , { field: 'validFlag', title: '客户端MAC' }
        , { field: 'validFlag', title: '客户端IP' }
