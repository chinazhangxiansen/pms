var alignmentFns = {
    inputs: [],
    init: function(input, step, max, min, digit,func) {
        ...
        $("#" + input.attr('id') + "l").click(function() {
            ...
            _this.execute(input, step, max, min, digit, true,func,this);
        });
        $("#" + input.attr('id') + "r").click(function() {
            _this.execute(input, step, max, min, digit, false,func,this);
        });
    },
    execute: function(input, step, max, min, digit, _do,func,_this) {
        ...
        if(func != undefined && func != null) eval(func).call(_this);
    ...
    initialize: function() {
        ...
        inputs.each(function() {
            ...
            //自动装载
            alignmentFns.init($(this), user_data.step, user_data.max, user_data.min, user_data.digit,user_data.func);
